        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="<?= base_url('Admin/') ?>daftar_modul" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="<?= base_url('Admin/') ?>daftar_event" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              ...
              <a href="<?= base_url('Admin/') ?>daftar_admin" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="<?= base_url('Admin/') ?>daftar_peserta" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
              ...
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Username</b> <a class="float-right">superadmin</a>
                  </li>
                  <li class="list-group-item">
                    <b>Email</b> <a class="float-right" style="font-size: 13px;">superadmin@sobatkode.com</a>
                  </li>
                  <li class="list-group-item">
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" id="deskripsi">
                    <!-- Post -->
                    <div class="post">
                      <h3><strong>Halo Super Admin</strong></h3>
                      <br>
                  ...
                  <div class="tab-pane" id="edit_tentangsaya">
                    <form class="form-horizontal">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <textarea class="form-control" id="inputQoutes" placeholder="Qoutes"></textarea>
                        </div>
                      </div>
                      <div class="form-group row">
                        <div class="offset-sm-10">
