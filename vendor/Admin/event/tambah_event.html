  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Sobat Kode</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../modul/daftar_modul.html" class="nav-link">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../event/tambah_event.html" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tambah Event</p>
                </a>
              </li>
    ...
    $('.swalDefaultSuccess').click(function() {
      Toast.fire({
        ...
        title: 'Satu event berhasil ditambahkan'
          ...
          location.replace("../event/tambah_soal.html");
          return 0;
      });
    });
